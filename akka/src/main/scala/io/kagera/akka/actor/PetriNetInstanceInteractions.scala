...
object PetriNetInstanceInteractions {
  ...
  implicit class ActorRefAdditions(actor: ActorRef)(implicit actorSystem: ActorSystem) {
     ...
     */
    def fireAndConfirmAll[S](topology: ExecutablePetriNet[S], msg: Any, waitForRetries: Boolean = false)(implicit timeout: Timeout): Future[S] = {
      Future {
     ...
     */
    def fireAndCollectResponses[S](topology: ExecutablePetriNet[S], msg: Any, waitForRetries: Boolean = false)(implicit timeout: Timeout): Seq[Try[TransitionFired[S]]] = {
