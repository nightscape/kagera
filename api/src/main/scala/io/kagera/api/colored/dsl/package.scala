...
package object dsl {
  ...
  def constantTransition[I, O](id: Long, label: String, isManaged: Boolean = false, constant: O) =
    new AbstractTransition[I, O](id, label, isManaged, Duration.Undefined) {
      override def apply(inAdjacent: MultiSet[Place[_]], outAdjacent: MultiSet[Place[_]])(implicit executor: ExecutionContext): (ColoredMarking, Context, I) ⇒ Future[(ColoredMarking, O)] =
  ...
  def nullTransition(id: Long, label: String, isManaged: Boolean = false) = constantTransition[Null, Null](id, label, isManaged, null)
