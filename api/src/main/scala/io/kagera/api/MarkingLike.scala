...
trait MarkingLike[M, P] {
   ...
   * @param m marking
   * @param other other
   * @return Whether other is a submarking of m or not
   */
   ...
   *
   * @param from Tokens
   * @param other The tokens to consume in from
   * @return Marking
   */
   ...
   *
   * @param from Tokens
   * @param other Tokens to remove from from if they exist in from
   * @return Marking
   */
   ...
   *
   * @param into The marking in which to produce the other tokens
   * @param other Tokens
   * @return Marking
   */
